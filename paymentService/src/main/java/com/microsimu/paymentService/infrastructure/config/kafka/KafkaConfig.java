...
public class KafkaConfig {
	...
	public KafkaMessageListenerContainer<String, Object> replyContainer(ConsumerFactory<String, Object> cf) {
		ContainerProperties containerProperties = new ContainerProperties(
				topicPaymentProductReplyName, topicPaymentDeliveryReplyName
		); // TODO add multiple topics
	...
	public ConsumerFactory<String, Object> consumerFactory() {
		...
		props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, com.microsimu.paymentService.infrastructure.config.kafka.KafkaBlockingMessage.class);
