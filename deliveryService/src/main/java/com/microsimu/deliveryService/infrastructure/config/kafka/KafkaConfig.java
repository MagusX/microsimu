...
public class KafkaConfig {
	...
	@Value("${ktopic.delivery-payment-reply.name}")
	private String topicDeliveryPaymentReplyName;

	@Value("${spring.kafka.consumergroup}")
	private String consumerGroup;

	@Value("${kstream.application-id}")
	...
	public ConsumerFactory<String, Object> consumerFactory() {
		...
		props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, com.microsimu.deliveryService.infrastructure.config.kafka.KafkaBlockingMessage.class);
